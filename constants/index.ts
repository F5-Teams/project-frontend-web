...
export const hotelServices = [
  {
    ...
    details: {
      size: "45m²",
      bed: "1 giường lớn cao cấp",
      view: "Hồ bơi hoặc vườn",
      maxGuests: 2,
      amenities: [
        "Điều hòa riêng",
        "Ban công riêng",
  ...
  },
  {
    ...
    details: {
      size: "25m²",
      bed: "1 giường tiêu chuẩn",
      view: "Hướng phố",
      maxGuests: 1,
      amenities: ["Quạt & điều hòa", "Thảm mềm", "Khay ăn & nước"],
    },
  },
  {
    id: "room3",
    ...
    details: {
      size: "60m²",
      bed: "3 giường thú cưng",
      view: "Sân chơi ngoài trời",
      maxGuests: 4,
      amenities: [
        "Khu vui chơi trong phòng",
        "Hệ thống khử mùi",
        "Máy lọc không khí",
      ],
    },
  },
  {
    ...
    subtitle: "Không gian rộng rãi cho nhóm thú cưng năng động.",
    price: "Từ 750.000đ/đêm",
    img: "/images/hotel4.jpg",
    details: {
      size: "65m²",
      bed: "3 giường + khu đệm chơi",
      view: "Công viên",
      maxGuests: 5,
      amenities: [
        "Sân cỏ mini trong phòng",
        "Đệm chống trượt",
        "Camera theo dõi",
      ],
    },
  },
  {
    ...
    subtitle: "Phòng cao cấp, nhiều không gian sinh hoạt.",
    price: "Từ 800.000đ/đêm",
    img: "/images/hotel5.jpg",
    details: {
      size: "70m²",
      bed: "4 giường thú cưng",
      view: "Hồ nhân tạo",
      maxGuests: 6,
      amenities: ["Đồ chơi thông minh", "Khu leo trèo", "Thảm massage chân"],
    },
  },
  {
    id: "room6",
    title: "VIP Family Room",
    subtitle: "Phòng VIP rộng nhất với nhiều tiện nghi cao cấp.",
    price: "Từ 1.000.000đ/đêm",
    img: "/images/hotel6.jpg",
    details: {
      size: "100m²",
      bed: "5 giường hạng sang",
      view: "Toàn cảnh khu nghỉ dưỡng",
      maxGuests: 8,
      amenities: ["Phòng cách âm", "Hồ bơi mini trong phòng", "Thảm sưởi ấm"],
    },
  },
];

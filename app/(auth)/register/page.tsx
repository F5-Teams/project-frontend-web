          ...
          {!showOtpForm ? (
            ...
            <>
              ...
              <p className="text-sm text-gray-600 mb-4 text-center">
                ...
                <strong className="text-pink-600">{formData.email}</strong>
              </p>
              ...
              <form onSubmit={handleVerifyOtp} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full text-center text-2xl font-poppins-medium tracking-widest border border-ring rounded-lg px-3 py-3"

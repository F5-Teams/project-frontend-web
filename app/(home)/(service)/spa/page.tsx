...
import { useSpaCombos } from "@/services/spa";
          ...
          <div className="max-w-6xl mx-auto px-6 text-center">
            ...
            >
              ...
              <p className="mt-6 text-slate-600 max-w-2xl mx-auto text-lg leading-relaxed">
                Chúng tôi mang đến cho thú cưng của bạn sự chăm sóc toàn diện,
                từ{" "}
            ...
            >
              <div className="flex flex-col  md:flex-row items-center gap-10">
                ...
                <div className="flex-1 text-slate-600 text-lg leading-relaxed">
                  <p>
                    Chúng tôi mang đến một trải nghiệm boarding khác biệt cho
                    thú cưng, nơi các boss được ở trong môi trường gia đình ấm
                    cúng thay vì lồng sắt. Với đội ngũ chăm sóc tận tâm, mỗi bé
                    được quan tâm chu đáo và vui chơi an toàn.
                  </p>
        ...
        >
          <section className="py-20 bg-pink-50">
            <div className="max-w-5xl mx-auto px-6 text-left space-y-8">
              ...
              <p className="text-slate-600 text-lg leading-relaxed">
                Chúng tôi hiểu rằng mỗi thú cưng có nhu cầu khác nhau, vì vậy
                các dịch vụ được cá nhân hóa hoàn toàn. Từ chế độ ăn, hoạt động
                vui chơi, đến phương pháp huấn luyện, mọi thứ đều được thiết kế
                để phù hợp với từng bé.
              </p>
              <p className="text-slate-600 text-lg leading-relaxed">
                Với{" "}
              ...
              <p className="text-slate-600 text-lg leading-relaxed">
                Chúng tôi tin rằng một thú cưng hạnh phúc sẽ mang lại niềm vui
                cho cả gia đình. Hãy để PetCare trở thành người bạn đồng hành
                đáng tin cậy của bạn và bé yêu.
              </p>
            </div>
          </section>
        </motion.section>
        ...
        >
          <div className="max-w-6xl mx-auto px-6 space-y-12">
            ...
            <p className="text-lg text-slate-600 text-center max-w-3xl mx-auto leading-relaxed">
              ...
              tin rằng mọi thú cưng đều xứng đáng được chăm sóc tận tâm, vui
              chơi an toàn, và cảm thấy hạnh phúc mỗi ngày. Từ những buổi spa
              nhỏ cho đến boarding dài ngày, chúng tôi luôn đặt trái tim vào
              từng chi tiết.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                ...
                <p className="text-slate-700 leading-relaxed mb-4">
                  “Tôi cực kỳ yên tâm khi gửi bé Corgi của mình tại PetCare.
                  Hình ảnh và video mỗi ngày giúp tôi thấy bé vui chơi, ngủ ngon
                  và khỏe mạnh. Không gian ở đây ấm áp và đội ngũ nhân viên thân
                  thiện, đáng tin cậy.”
                </p>
                <p className="text-slate-700 leading-relaxed mb-4">
                  “Các dịch vụ huấn luyện, spa, và boarding đều được thực hiện
                  chuyên nghiệp. Tôi không chỉ thấy thú cưng hạnh phúc mà còn
                  thấy được niềm đam mê của PetCare trong từng chi tiết chăm
                  sóc.”
                </p>
                <p className="font-semibold text-pink-600">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="order-last md:order-first">
                ...
                <p className="text-slate-700 leading-relaxed mb-4">
                  PetCare không chỉ là dịch vụ một lần, mà là người bạn đồng
                  hành lâu dài. Chúng tôi luôn cập nhật và cải thiện dịch vụ để
                  đảm bảo mỗi thú cưng đều được chăm sóc chu đáo, vui vẻ và khỏe
                  mạnh.
                </p>
